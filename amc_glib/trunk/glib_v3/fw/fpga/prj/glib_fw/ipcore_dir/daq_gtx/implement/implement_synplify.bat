...
COPY daq_gtx_top.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\daq_gtx_top.ucf -p xc6vlx130t-ff1156-1 daq_gtx_top.edf daq_gtx_top.ngd
...
ECHO 'Running NGD'
map -p xc6vlx130t-ff1156-1 -o mapped.ncd daq_gtx_top.ngd
...
netgen -ofmt vhdl -sim -dir . -tm daq_gtx_top -w routed.ncd routed.vhd
