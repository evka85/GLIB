...
xst -ifn xst.scr
move clk25mhz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk25mhz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk25mhz_exdes.ucf clk25mhz_exdes

echo 'Running map'
map -timing -pr b clk25mhz_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk25mhz_exdes -w routed.ncd routed.vhd
cd ..
