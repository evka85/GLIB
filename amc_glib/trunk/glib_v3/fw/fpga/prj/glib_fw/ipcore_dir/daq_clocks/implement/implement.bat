...
xst -ifn xst.scr
move daq_clocks_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\daq_clocks_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc daq_clocks_exdes.ucf daq_clocks_exdes

echo 'Running map'
map -timing -pr b daq_clocks_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm daq_clocks_exdes -w routed.ncd routed.vhd
cd ..
